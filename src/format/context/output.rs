...
impl Output {
	...
	pub fn add_chapter<R: Into<Rational>>(&mut self, id: i32, time_base: R,
	                                      start: i64, end: i64, title: &str) -> Result<ChapterMut, Error> {
        ...
        let index = match existing_index {
            ...
            None => unsafe {
                ...
                let mut nb_chapters;
                {
                    nb_chapters = (*self.as_ptr()).nb_chapters as i32;
                }
                av_dynarray_add(
